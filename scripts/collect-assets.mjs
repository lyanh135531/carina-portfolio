...
const outputRoot = path.resolve("public/assets/portfolio");
const manifestPath = path.resolve("src/data/assetManifest.json");

const pages = [
  { name: "home", url: "https://tronhouse.com/" },
  { name: "services", url: "https://tronhouse.com/services" },
  ...
  { name: "about", url: "https://tronhouse.com/about" },
  { name: "credential", url: "https://tronhouse.com/credential" },
...
const downloadAsset = async (assetUrl, pageName) => {
  ...
  const publicPath = `/assets/portfolio/${pageName}/${filename}`;
